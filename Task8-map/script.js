...
function capitalizeNames(arr){
    return arr.map(name => name.toUpperCase()[0] + name.slice(1).toLowerCase())
}
console.log(capitalizeNames(["john", "JACOB", "jinGleHeimer", "schmidt"]))
...
function makeStrings(arr){
    return arr.map(element => element.age >17 ?" "+element.name+" can go to The Matrix"  : " "+element.name+" is under age!!");
}
console.log(makeStrings([
    {
        name: "Angelina Jolie",
